        ...
        switch(arg){
            ...
            case 'update-available':
                ...
                if(process.platform === 'darwin'){
                    info.darwindownload = `https://github.com/laurent-offi/MagicalLauncher/releases/download/v${info.version}/Helios-Launcher-setup-${info.version}${process.arch === 'arm64' ? '-arm64' : '-x64'}.dmg`
                    showUpdateUI(info)
                }
            ...
            case 'update-not-available':
                ...
                settingsUpdateButtonStatus('Rechercher les mises à jour')
                break
            case 'ready':
